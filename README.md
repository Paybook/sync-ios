...
- [Quickstart para sincronizar al SAT](ttps://github.com/Paybook/sync-ios/blob/master/Example/Quickstart_sat.md)

- [Quickstart para sincronizar una cuenta bancaria con credenciales sencillas (usuario y contraseña)](ttps://github.com/Paybook/sync-ios/blob/master/Example/Quickstart_normal_bank.md)

- [Quickstart para sincronizar una cuenta bancaria con token (usuario y contraseña)](ttps://github.com/Paybook/sync-ios/blob/master/Example/Quickstart_token_bank.md)
